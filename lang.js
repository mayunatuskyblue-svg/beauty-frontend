...
T.en.smartpay = {
  ...
  T.ja = Object.assign({}, T.ja, {
    ...
    pay:{title:'SmartPay（後払い）', method:'SmartPay', method_title:'お支払い', pay_stripe:'カードを保存して予約する', pay_cash:'', // 現地払いは使わないので空に, note_open_newtab:'※ カード情報はStripeに安全に保存され、施術後に自動で課金されます（SmartPay）。', nonlink_title:'', nonlink_desc:'', choose_method_label:'SmartPay（後払い）で予約します' },    footer:{ terms:'Terms', privacy:'Privacy', cancel:'Cancel Policy', contact:'Contact' },
  ...
  T.ja.legal = Object.assign({}, T.ja.legal, { terms_full_html: `
    <div class="container">
      ...
      <h2>3. 予約と支払い</h2>
      <p>予約には SmartPay（後払い）を利用します。Stripe によりカード情報を安全に保存し、施術後に自動課金します。請求・キャンセル料は <a href="cancel.html">キャンセルポリシー</a> に従います。</p>
      <h2>4. キャンセル</h2>
  ...
  T.en = Object.assign({}, T.en, {
    ...
    pay:{ title:'SmartPay(pay later)', method:'SmartPay', method_title:'Payment', pay_stripe:'Save card to complete booking', pay_cash:'', note_open_newtab:'Your card is securely saved with Stripe. You will be charged automatically after the service (SmartPay).', nonlink_title:'', nonlink_desc:'', choose_method_label:'Proceed with SmartPay (pay later)' },
